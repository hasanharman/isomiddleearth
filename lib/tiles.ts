export const TILE_GROUPS = [
  ...
  },
  {
    ...
    row: 3,
    tiles: [
      { col: 0, label: "Small Dwelling" },
      { col: 1, label: "Medium Dwelling" },
      { col: 2, label: "Landmark Residence" },
      { col: 3, label: "Dwelling with Fence" },
      { col: 4, label: "Dwelling with Laundry" },
      { col: 5, label: "Dwelling with Mailbox" },
      { col: 6, label: "Empty" },
      { col: 7, label: "Empty" },
      { col: 8, label: "Empty" },
      { col: 9, label: "Empty" },
